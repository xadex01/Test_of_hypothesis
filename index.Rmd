...
Referring back to a previous example, say we take a random sample of 500 Penn State students and find that 278 are from Pennsylvania. Can we conclude that the proportion is larger than 0.5? Is 0.556 (\( \frac{278}{500} \)) **much bigger than** 0.5? What is much bigger?
...
Certainly! Below is the RMarkdown code for the given text:
...
The sample size necessary for estimating a population mean μ with (1− α)100% confidence and error no larger than ϵ is:
n=((z_(α/2)^2 ) s^2)/ϵ^2 
